...
#STEP 1: TO INSTALL REQUIRED PACKAGES:
  ...
  # (2) install.packages("shinyWidgets")
  # (3) install.packages("shinythemes")
  # (4) install.packages("DT")

#STEP 2: TO CHANGE YOUR WORKING DIRECTORY:
  # (1) Ctrl - Shift - H  OR  Session > Set Working Directory > Choose Directory
...
ui <- fluidPage(theme = shinytheme("cyborg"),
  ...
  titlePanel(
    img(src='https://raw.githubusercontent.com/ningsoong/pearlhacks2023/main/data/logo.png', height="20%", width="20%", align = "left"),
  ),
  
  setBackgroundImage(src = "https://raw.githubusercontent.com/ningsoong/pearlhacks2023/main/data/somethingeasy.png", shinydashboard = FALSE),
  
  h1(strong("WorkAround"), align="left", style = "font-size: 100px; color: #ffc20c"),
  
  sidebarLayout(
    
    span(sidebarPanel( #The areas for user input
  ...
  tags$
    ...
    span(mainPanel( #The area for workout output
      p("Workout"),
